...
public class ForwardDeadReckonLegalMoveSet implements ForwardDeadReckonComponentTransitionNotifier
{
  ...
  public ForwardDeadReckonLegalMoveSet(ForwardDeadReckonLegalMoveSet master)
  {
    ...
    roles = master.roles;
    preAllocatedCollections = new ForwardDeadReckonLegalMoveSetCollection[roles.size()];
    numActive = new short[roles.size()];
    numAlwaysActive = new short[roles.size()];
    linkage = new int[roles.size()][];
    firstActive = new short[roles.size()];
    lastImmutableActive = new short[roles.size()];
    lastActive = new short[roles.size()];
  ...
  public ForwardDeadReckonLegalMoveSet(List<Role> theRoles)
  {
    ...
    roles = new ArrayList<>(theRoles.size());
    preAllocatedCollections = new ForwardDeadReckonLegalMoveSetCollection[roles.size()];
    numActive = new short[roles.size()];
    numAlwaysActive = new short[roles.size()];
    linkage = new int[roles.size()][];
